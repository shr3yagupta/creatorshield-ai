...
$("language").onchange=(e)=>{
  ...
  if(selectedLanguage==="hindi"){
    ...
    $("subtitle").innerText="क्रिएटर्स के लिए AI सुरक्षा सहायक — संदेश पेस्ट करें, स्क्रीनशॉट या वॉइस अपलोड करें।";
    ...
    $("subtitle").innerText="AI security assistant for creators — Paste messages, upload screenshots or scam calls.";
